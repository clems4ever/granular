...
// TestIssueEditFactoryValidatesParams checks the issue-edit factory rejects params missing a repo.
...
// TestIssueEditRequirementsAreContentScoped checks different edits produce different content-scoped requirements.
...
// TestIssueEditDescribe checks the issue-edit description names the repo, issue and changes.
...
// TestIssueEditExecutePatches checks executing an issue edit PATCHes the issue with the merged fields.
...
// TestApplyAddRemove checks applyAddRemove merges add and remove sets against the current values.
...
// toStrings coerces a decoded JSON value into a slice of strings, dropping non-strings.
