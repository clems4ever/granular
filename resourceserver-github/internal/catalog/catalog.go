...
// their CLI commands. It is the single source the GitHub resource server builds its
...
type Catalog struct {
	...
	RequestExample resourceserver.GrantRequest `json:"request_example"`
}
...
func Build() Catalog {
	return Catalog{
		...
		RequestExample: resourceserver.GrantRequest{
			...
			Capabilities: []resourceserver.Capability{{
				...
				Resource: resourceserver.ResourceSelector{
					Type:  "github.repo",
