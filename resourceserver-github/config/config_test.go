...
func TestDefault(t *testing.T) {
	c := Default()
	if c.Addr != ":8080" || c.ResourceServerID != "github-resource-server" || c.ASURL != "http://localhost:9090" {
...
func TestLoadParsesYAML(t *testing.T) {
	...
	cfgPath := filepath.Join(dir, "rs.yaml")
	body := "resource_server_id: gw1\nas_url: http://as:9090\nsecret_file: " + secret + "\ngithub_token_file: " + tok + "\n"
	...
	if c.ResourceServerID != "gw1" || c.ASURL != "http://as:9090" {
